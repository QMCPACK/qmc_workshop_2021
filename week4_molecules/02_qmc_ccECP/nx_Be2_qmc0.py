...
qmc = generate_qmcpack(
    identifier   = 'vmc',
    path         = 'Be2/vmc_NoJ',         # directory to run in
...
qmc = generate_qmcpack(
    identifier   = 'vmc',
    path         = 'Be2/vmc_2J',         # directory to run in
    job          = job(cores=cores),                  # Submit with the number of cores available
    system       = system,                                                                        
    pseudos      = 'ccecp',
    jastrows     = [],                                                                            
...
qmc = generate_qmcpack(
    identifier   = 'vmc',
    path         = 'Be2/vmc_3J',         # directory to run in
    job          = job(cores=cores),                  # Submit with the number of cores available
    system       = system,                                                                        
    pseudos      = 'ccecp',
    jastrows     = [],                                                                            
...
qmc = generate_qmcpack(
    identifier   = 'dmc',
    seed         = 42,
    path         = 'Be2/dmc_NoJ',         # directory to run in
    job          = job(cores=cores),                  # Submit with the number of cores available
    system       = system,
    pseudos      = 'ccecp',
    jastrows     = [],
...
qmc = generate_qmcpack(
    identifier   = 'dmc',
    seed         = 42,
    path         = 'Be2/dmc_2J',         # directory to run in
    job          = job(cores=cores),                  # Submit with the number of cores available
    system       = system,                                                                                  
    pseudos      = 'ccecp',
    jastrows     = [],                                                                                      
...
qmc = generate_qmcpack(
    identifier   = 'dmc',
    seed         = 42,
    path         = 'Be2/dmc_3J',         # directory to run in
    job          = job(cores=cores),                  # Submit with the number of cores available
    system       = system,                                                                                  
    pseudos      = 'ccecp',
    jastrows     = [],                                                                                      
